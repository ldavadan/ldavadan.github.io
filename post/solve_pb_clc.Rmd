...
In the context of the AGROMET project, we searched to include data from CORINE land cover in our models. I refer you to my post [How to get CORINE land cover data from Wallonia](https://ldavadan.github.io/post/) where I explained how we got data and how we reclass land covers in groups.
