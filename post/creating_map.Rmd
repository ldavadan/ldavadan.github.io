...
To do that, I used data from the [AGROMET API](https://ldavadan.github.io/2018/05/30/using-agromet-api-to-get-weather-data/) using methods I have already detailed before.
